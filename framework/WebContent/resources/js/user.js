...
function is_registered( username )
{
    ...
    Ajax.call( 'user.do?action=is_registered', 'username=' + username, registed_callback , 'GET', 'TEXT', true, true );
}
...
function checkEmail(email)
{
  ...
  Ajax.call( 'user.do?action=check_email', 'email=' + email, check_email_callback , 'GET', 'TEXT', true, true );
}
...
function register()
{
  ...
  var phone = frm.elements['extend_field1'] ? Utils.trim(frm.elements['extend_field1'].value) : '';
